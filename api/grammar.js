export default async function handler(req, res) {
  ...
  const TENSES = {
    ...
    ru: ["Настоящее время (несов.)","Прошедшее время — муж.р. (сов.)","Прошедшее время — жен.р. (сов.)","Прошедшее время — ср.р. (сов.)","Прошедшее время — мн.ч. (сов.)","Прошедшее время (несов.)","Будущее время простое (сов.)","Будущее время сложное (несов.)","Условное наклонение","Повелительное наклонение"]
  };
